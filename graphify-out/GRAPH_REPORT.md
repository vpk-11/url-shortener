...
## Corpus Check
- 13 files · ~2,224 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 79 nodes · 85 edges · 10 communities (8 shown, 2 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 1 edges (avg confidence: 0.75)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `755b47a7`
...
Cohesion: 0.15
Nodes (12): author, dependencies, dotenv, express, express-rate-limit, mongoose, nanoid, description (+4 more)
...
Cohesion: 0.32
Nodes (5): connectDB(), Request, requestId(), router, app

### Community 3 - "URL Validation and Code Gen"
Cohesion: 0.22
Nodes (8): sendError(), IUrl, Url, urlSchema, redirectCache, nanoidPromise, router, shortenLimiter
...
## Knowledge Gaps
- **47 isolated node(s):** `name`, `version`, `description`, `main`, `dev` (+42 more)
